...
--
-- Servidor: localhost
-- Tiempo de generación: 27-11-2017 a las 23:06:35
...
(1, 'tobias@cic.unam.mx', '$2y$10$2BnG4Y7QGCTnffyNiZ64uuO8rgTy2jbKcGgV329kMqasNMnsttgp6', NULL, 0, 1, 1, 8193, 1510932244, 1511821900),
...
(72, 1, 'EPEsQrX4Yao4zN1EfJsR0v-m', '$2y$10$4nS0ZOLYWoEV56zpmtExSuvgBN/GMK02A70eSg/eErGeLErRzisc2', 1543379500);
...
--
ALTER TABLE `Medicos`
  MODIFY `MedicosID` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `Protocolo`
  MODIFY `ProtocoloID` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
